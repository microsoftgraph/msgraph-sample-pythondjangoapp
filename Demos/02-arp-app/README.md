...
Now that you've created the app registration, you can continue to the next module, [Extend the Python Django app for Azure AD Authentication](../03-add-aad-auth/README.md).